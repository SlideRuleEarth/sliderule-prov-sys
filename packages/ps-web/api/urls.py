...
urlpatterns = [
    ...
    path('desired_org_num_nodes/<str:name>/<int:desired_num_nodes>/', views.DesiredOrgNumNodesView.as_view(),name='put-org-num-nodes'),
    path('desired_org_num_nodes_ttl/<str:name>/<int:desired_num_nodes>/<int:ttl>/', views.DesiredOrgNumNodesTTLView.as_view(), name='post-org-num-nodes-ttl'),
    path('org_num_nodes/<str:name>/', views.OrgNumNodesView.as_view(), name='get-org-num-nodes'),
    ...
    path('remove_user_org_num_nodes_reqs/<str:name>/', views.RemoveUserOrgNumNodesReqsView.as_view(), name='remove-user-org-num-nodes-reqs'),
    path('remove_all_org_num_nodes_reqs/<str:name>/', views.RemoveAllOrgNumNodesReqsView.as_view(), name='remove-all-org-num-nodes-reqs'),
