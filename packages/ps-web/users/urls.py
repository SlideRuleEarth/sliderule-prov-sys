...
urlpatterns = [
     ...
     path('clear_num_nodes_reqs/<str:pk>/', views.clearOrgNumNodesReqs, name='clear-org-num-nodes-reqs'),
     path('clear_active_num_node_req/<str:pk>/', views.clearActiveOrgNumNodeReq, name='clear-active-org-num-node-req'),
